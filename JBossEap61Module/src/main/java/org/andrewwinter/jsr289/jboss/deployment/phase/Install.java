...
public class Install extends AbstractDeploymentUnitProcessor {
    ...
    private void deployApplicationRouter(final DeploymentPhaseContext dpc) throws DeploymentUnitProcessingException {
        ...
        if (iter.hasNext()) {
            ...
            final SipServletContainerService service = getSipServletContainerService(dpc);
    ...
    private void deployApplication(final DeploymentPhaseContext dpc) throws DeploymentUnitProcessingException {
        ...
        final ServiceName serviceName = du.getServiceName().append(SipDeploymentUnitService.NAME);
        final SipDeploymentUnitService service = new SipDeploymentUnitService(du, namespaceContextSelector);
        ...
        serviceTarget
                ...
                .addDependency(SipServletContainerService.NAME)
