...
public class SipMessageFactory {
     ...
     * @param dialog
     * @param method
     * @param Via Use null if this is to be generated by this method.
     * @param CSeq Use null if this is to be generated by this method.
     * @return 
     */
    ...
    public static SipRequest createAck(final InboundSipResponse isr) {
        ...
        final SipRequest ack = createInDialogRequest(
                isr.getDialog(),
                "ACK",
                createVia("ACK", invite),

                // The sequence number of the CSeq header field MUST be the same
                // as the INVITE being acknowledged, but the CSeq method MUST be
                // ACK.
                new CSeq("ACK", invite.getCSeq().getSequence()));
